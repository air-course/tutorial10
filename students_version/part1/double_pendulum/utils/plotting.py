...
def plot_timeseries(
    ...
    with mpl.rc_context(rc_params):
        fig, ax = plt.subplots(n_subplots, 1, figsize=(18, n_subplots * 3), sharex="all")
...
def plot_timeseries_csv(csv_path, read_with="pandas"):
    ...
    plot_timeseries(T=time, X=X, U=U, ACC=ACC, plot_acc=plot_acc)
